...
```mermaid
flowchart TB
  L0["λ = 0.0<br/>Ligand A fully interacting"]
  
  E1["Electrostatics Decoupling<br/>Charges of A → 0"]
  V1["VDW Transformation<br/>Soft-core A → B"]
  E2["Electrostatics Recoupling<br/>Charges of B → full"]
  
  L1["λ = 1.0<br/>Ligand B fully interacting"]
