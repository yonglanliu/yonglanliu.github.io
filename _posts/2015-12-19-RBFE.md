...
### 📐 Completing the Thermodynamic Cycle (Two Legs)
...
     
The final Relative Binding Free Energy is the difference between these two alchemical transformations: &Delta;&Delta;G<sub>binding</sub> = &Delta;G<sub>complex</sub> - &Delta;G<sub>solvation</sub>
