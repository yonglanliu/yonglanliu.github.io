...
<p style="text-align: center;">
&Delta;G<sub>bind</sub> = &Delta;G<sub>decouple</sub><sup>protein</sup> - &Delta;G<sub>decouple</sub><sup>solvent</sup>
</p>

|    State  |            Physical Process                 | Alchemical Process (Decoupling) |
| ----------| ------------------------------------------- | ------------------------------- |
| **Bound** |       Ligand + Protein &harr; Complex       | &Delta;G<sub>decouple</sub><sup>protein</sup>:Turn off the ligand's interactions with its environment (protein and solvent) in the binding pocket. |
| **Unbound (Solvent)** | Ligand (gas) &harr; Ligand (solvent) | &Delta;G<sub>decouple</sub><sup>solvent</sup>: Turn off the ligand's interactions with the bulk solvent. |
